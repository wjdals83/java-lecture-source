...
//        System.out.print("1번 째 학생 이름을 입력해주세요 : ");
//        String student1 = sc.nextLine();
//        System.out.println("1번 째 학생 이름은 " + student1 + "입니다.");
//
...
//        System.out.println("5번 째 학생의 이름은 " + student4 + "입니다. ");
//
...
//            System.out.print(dan + " * " + 4 + "=" + (dan * 4));
//            System.out.print(dan + " * " + 5 + "=" + (dan * 5));
//            System.out.print(dan + " * " + 6 + "=" + (dan * 6));
//            System.out.print(dan + " * " + 7 + "=" + (dan * 7));
//            System.out.print(dan + " * " + 8 + "=" + (dan * 8));
//            System.out.print(dan + " * " + 9 + "=" + (dan * 9));
