...
public class C_ifElseIf {
    ...
    public void testSimpleIfElseIfStatement() {
        ...
        *   } else if {
        *       조건식 1이 false 이고, 조건식 2가 true일 때 실행할 명령문;
        *   } else {
        ...
        * */
        ...
        if (answer == 1) {
            ...
            System.out.println("이런 거짓말쟁이!! 너에게는 아무런 도끼도 줄 수 없다.. 이 욕심쟁이..");
        } else if (answer == 2) {       //else는 아니면, else if는 아니면 만약에~ 느낌으로

            System.out.println("욕심이 과하지는 않지만 그래도 넌 거짓말을 해부렀으.. 썩 꺼지거라");
        } else {

            System.out.println("오~~ 정직한 놈이루구나.. 여기 있는 모든 도끼를 너에게 주마");
