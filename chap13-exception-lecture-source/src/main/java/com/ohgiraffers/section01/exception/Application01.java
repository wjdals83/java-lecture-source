...
public class Application01 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        /* 수업목표. 예외에 대해 이해하고 이를 처리하기 위한 문법을 이요할 ㅅ 있다. */
        /* 필기.
        *   예외처리
        ...
        *    이리한 오류는 개발자가 미리 예측하여 처리하는 것이 불가능하며, 오류에 대한
        *    처리는 할 수 없다.
        *    예외(Exception)
...
//        et.checkEnoughMoney(10000, 50000);
        ...
        et.checkEnoughMoney(50000, 10000);          // 예외 발생 구문 이하 구문은 동작하지 않고 종료. 에러가 나면 동작을 멈춰서 밑 부분은 나오지 않는다.
