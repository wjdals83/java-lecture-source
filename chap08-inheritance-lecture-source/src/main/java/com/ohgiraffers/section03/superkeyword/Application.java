...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.println(product1.getInfo());     // 값을 안정해 주었으니 null, 0 이 나온다.

        // Product 모든 필드 초기화 하는 생성자
        Product product2 = new Product("A-1230", "삼송", "갠역시S2", 2000, new java.util.Date());
        ...
        Computer computer3 = new Computer("A-1234", "삼송", "걘역시S2", 2000, new java.util.Date()
                , "i9", 512, 32, "윈도우");
