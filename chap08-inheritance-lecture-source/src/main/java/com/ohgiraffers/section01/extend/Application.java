...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /* 필기.
         *   상속(inheritance) 는 현실 세계의 상속과 비슷한 개념이다.
         *   부모가 가지고 있는 재산(자바에서는 클래스가 가지는 멤버)을 자식이 물려받는 의미이다.
         *   클래스 또한 부모 클래스와 자식 클래스로 역할을 나누어 부모가 가지는 멤버를 자식이
         ...
         *       1-1. 재사용 시 생산성을 크게 향상시킬 수 있따. (새로 작성하는 것 보다 빠르다.)
         ...
         *   2. 또한 부모클래스이 변경 또한 쉽지 않다. 자식 클래스에서 중요하게 사용하는 기능인 경우
         ...
         *   필기.
         *    장점과 단점을 고려했을 때,
         *    상속은 재사용이라는 장점만 바라보게 되면 오용의 가능이 있기 때문에 유지보수에 좋지 않은
         *    코드를 작성할 확률이 높다.
