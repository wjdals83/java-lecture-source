...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.println("non-static field : " + sft1.getNonStaticCount());      // 0. 겟 -> 간접적으로 접근 가능
        System.out.println("static field : " + sft1.getStaticCount());      // 0. jvn이 제공하는 기본값이 0.

        /* 두 필드의 값을 1씩 증가 시킨 후 다시 값 확인 */
        sft1.increaseNonStaticCount();
        sft1.intcreaseStaticCount();
        ...
        System.out.println("static field : " + sft2.getStaticCount());      // 1. 이미 만ㄷ르어진 위의 값을 재사용 한 것.

        /* 필기.
        *   인스턴스 변수의 경우 sft 과 sft2 두 개의 인스턴스가 서로 값을 공유 하지 못하고
        ...
        * */
        smt.staticMethod();     // 호출은 가능하나, 권장하지 않음.

        /* 목차. 2-2. static 메소드 호출 */
        /* 필기. 클래스명.메소드명 */

        StaticMethodTest.staticMethod();        // 이거를 권장함.
