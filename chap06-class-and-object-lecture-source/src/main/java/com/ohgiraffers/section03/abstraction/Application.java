...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        *   프로글맹르 만들 때 이용하여 새로운 세계를 창조한다는 방법론이다.
        *   현실 세계와 닮아있지만, 다른 점은
        *   객체간의 상호 작용을 한다는 사실은 현실 세계와 동일하지만 의인화 기법이 적용되어
        *   현실세계에서 불가능한 무생물이나 개념 같은 존재들도 하나으 주체로
        ...
        *   순차적으로 기술한 것을 메소드 라고 한다.     //메소드 -> 어떻게 처리할 것인지?에 대한 방법??
        *   상호작용에 중요한 것은 메세지를 송수신 하고 그 방법을 기술하여 메세지에 응답하는 상호작용을
        *   설계하는 것이다.
        *   따라서 객체를 설계할 때는 속성은 부가적이며, 적절한 책임을 가진 개체들 간 주고 받는 메세지를
