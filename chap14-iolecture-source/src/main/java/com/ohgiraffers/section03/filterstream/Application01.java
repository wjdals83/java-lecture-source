...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        try {
            bw = new BufferedWriter(new FileWriter("src/main/java/com/ohgiraffers/section03/filterstream/testBuffered.txt"));       // new fileWriter 기본 스트림 넣기

            bw.write("안녕하세요\n");
            bw.write("반갑습니다\n");

            /* 필기.
            *   버퍼를 사용하는 경우 버퍼가 가득 차지 않은 상태에서는 강제로 내보내기(flush)를 해야 한다.
            * */
            bw.flush();
            ...
            if(bw != null) {        // bw 에 데이터가 존재한다면 이라는 뜻.
