...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        *  */
        ...
        /* 필기.
        *   형변환의 종류와 규칙
        *   1. 자동형변환(묵시적 형변환) : 컴파일러가 자동으로 수행해주는 타입 변환      //데이터의 유실이 없다.
        ...
        * */
        ...
        /* 필기. 작은 자료형에서 큰 자료형으로 공간만 옮기는 경우 데이터 손실이 발생하지 않기 때문에 자동으로 처리해 준다. */
...
//        int result1 = num1 + num2; //자동으로 큰 쪽 자료형은 long으로 변경 후 ㄱ산하기 때문에 int형 변수에 값을 담을 수 없다.
        ...
        /* 필기.
        *   정수를 실수로 변경할 때 소수점 자리수가 없어도 실수형태로 표현이 가능하다. 이때 데이터 손실!!!이 없기 때문에 자동으로 진행한다.
        * */
