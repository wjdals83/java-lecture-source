...
public class Application03 {
    ...
    public static void main(String[] args) {
        ...
        *   2. 컴파일 에러를 발생시키지는 않지만 개발자들끼리의 암묵적이니 규칙
        *       2-1. 변수명의 길이 제한은 없다. (하지만 적당히 해야겠죠?)
        *       2-2. 변수명이 합성어로 이루어진 경우 첫 단어는 소문자, 두 번째 단어는 대문자로 시작한다.
...
//        int s#adad = 20;
        ...
        /* 목차. 2-6. 전형적인 변수 이름이 ㅣ있다면 가급적 사용하도록 한다. */
        int sum = 0;
        int max = 10;
        int min = 0;
        int count = 1;
