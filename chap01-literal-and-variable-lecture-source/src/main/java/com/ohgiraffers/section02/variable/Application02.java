...
public class Application02 {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        /* 필기.
        *   자료형이란?
        *   다양한 값의 형태별로 어느 정도의 크기를 하나의 값으로 취급할 것인지 미리 compiler 와 약속한 키워드이다.
        ...
        * */
        ...
        snum = 2;
        inum = 4;
        lnum = 8L;       // 아무 문제 없는 것 같지만 사실 뒤에 대문자 L을 붙어야 한다. 그 이유는 뒤에 형변환에서 다루게 될 것이다.
