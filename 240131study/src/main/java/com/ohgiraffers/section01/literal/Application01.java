...
//        System.out.println('');       // 아무 문자도 기록되지 앟는 경우 에러.
        System.out.println('1');        // 숫자 값이지만 홀따옴표로 감싸져 있는 경우 문자 '1'로 판단.

        /*목차. 3. 문자열 형태의 값 출력*/
        System.out.println("안녕하세요 서정민 입니다.");        // 문자열은 문자 여러 개가 나연된 형태를 말하며 쌍따옴표(double-quotation)로 감싸주어야 한다.
        System.out.println("123");                          // 정수이지만 쌍따옴표로 감싸져 있기 때문에 문자열로 보아야 한다.
        System.out.println("");                             // 아무 값도 없는 빈 쌍따옴표도 문자열로 취급.
