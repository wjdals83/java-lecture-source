...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.println("inum1이 inum2 보다 작거나 같은지 비교 : " + (inum1 <= inum2));
...
//
        ...
        String strl = "java";
        String strl2 = "javaaaa";

        System.out.println("======================문자열 값 비교===================");
        System.out.println("strl1과 strl2가 같은지 비교 : " + (strl == strl2));
        System.out.println("strl1과 strl2가 다른지 비교 : " + (strl != strl2));
        System.out.println("=====================================================");
//        System.out.println("strl1과 strl2가 다른지 비교 : " + (strl > strl2));
//        System.out.println("strl1과 strl2가 다른지 비교 : " + (strl >= strl2));
//        System.out.println("strl1과 strl2가 다른지 비교 : " + (strl < strl2));
