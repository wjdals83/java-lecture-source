...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        int[] num;
        num = new int[5];       // new는 heap메모리에 5가지의 공간을 만들겠다. 정수 형태의 배열이다.

        char[] cnum;
        int num1[];     //가능하나 뒤에 붙이는 건 잘 사용 X
...
//        iarr = new int[];       //크기를 지정해 주어야 한다.
        ...
        System.out.println("age[0] : " + age[0]);       //age[0] 공간에 값을 넣어주지 않으면 '0'이 나온다. heap영역은 값이 없는 공간이 존재할 수 없으므로 기본값 0이 출력됨.
        System.out.println("age[1] : " + age[1]);       //age[0] 공간에 값을 넣어주지 않으면 '0'이 나온다. heap영역은 값이 없는 공간이 존재할 수 없으므로 기본값 0이 출력됨.
        System.out.println("age[2] : " + age[2]);       //age[0] 공간에 값을 넣어주지 않으면 '0'이 나온다. heap영역은 값이 없는 공간이 존재할 수 없으므로 기본값 0이 출력됨.
        System.out.println("age[3] : " + age[3]);       //age[0] 공간에 값을 넣어주지 않으면 '0'이 나온다. heap영역은 값이 없는 공간이 존재할 수 없으므로 기본값 0이 출력됨.
        System.out.println("age[4] : " + age[4]);       //age[0] 공간에 값을 넣어주지 않으면 '0'이 나온다. heap영역은 값이 없는 공간이 존재할 수 없으므로 기본값 0이 출력됨.
        ...
        * */
        ...
        int[] iarr5 = new int[] {10, 20, 30, 40, 50, 60};     //가능은 하나 위의 방식이 더 간편하다.
