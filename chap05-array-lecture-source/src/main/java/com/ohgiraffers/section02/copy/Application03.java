...
public class Application03 {
    ...
    * */
        ...
        for(int i = 0; i < originArr.length; i++) {
            copyArr1[i] = originArr[i];             // 오리진과 같은 인덱스 값이 카피에 들어가게 됨.
        }

        // 원본 배열과 복사한 값은 같은 값을 가지고 나머지 인덱스는 다른 값이다.
        print(copyArr1);            // 1 2 3 4 5 0 0 0 0 0  이런식으로 나옴.

       /* 목차. 2. Object의 clone() 을 이용한 복사 */
        int[] copyArr2 = originArr.clone();     //clone을 입력하여 복사를 한다.
